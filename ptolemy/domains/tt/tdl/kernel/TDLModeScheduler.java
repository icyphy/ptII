...
public class TDLModeScheduler extends LetModeScheduler {
	...
	/**
	 * Schedule a single activity with a given time in a mode period.
	 * @param activityName The name of the activity.
	 * @param activity The activity to be scheduled.
	 * @param time Schedule the activity at this time.
	 ...
	 * @param ttModeSchedule Schedule generated by the TTModeScheduler. 
