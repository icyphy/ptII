...
*/
    ...
    rtb_Sum2 = (dynamicsControll_Y.delta_r_sprad - carModel_Y.rearangle) *
    motorController_P.Kphi_Gain - carModel_Y.anglerate;
...
//  rtb_Sum = rtb_temp4 - motorController_U.current;
  ...
  rtb_Sum = rtb_temp4 - carModel_Y.motorcurrent;
