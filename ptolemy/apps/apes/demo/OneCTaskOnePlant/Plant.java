...
public class Plant extends CTask {
    ...
    public Plant() throws IllegalActionException, NameDuplicationException { 
        super();
    }

    public Plant(Workspace workspace) throws IllegalActionException, NameDuplicationException {
        super(workspace); 
    }
