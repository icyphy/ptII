...
public class TDLModule extends ModalModel {
	...
	/** Construct a tdl module in the specified workspace with
     ...
     * 
     *  needs to be overridden because of the director class that 
     *  should always be TDLModuleDirector
     */
            ...
            if ((director == null)
                ...
                ChangeRequest request = new ChangeRequest(this,
                    ...
                    protected void _execute() throws Exception {
                        ...
                        Constructor newDirectorConstructor = newDirectorClass.getConstructor(new Class[] {
    ...
    private void _init() throws IllegalActionException,
        ...
        setClassName("ptolemy.domains.tt.tdl.kernel.TDLModule");
        directorClass.setExpression("ptolemy.domains.tt.tdl.kernel.TDLModuleDirector");
        _controller.removeAllEntities();
        _controller.removeAllPorts();
        _controller.removeAllRelations();
        _controller.setContainer(null);
        
        TDLModuleDirector defaultTDLDirector = new TDLModuleDirector(this, "_TDLDirector");
