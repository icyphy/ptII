...
public class IconEditor {
  ...
  SelectionInteractor interactor1 = new SelectionInteractor();
  SelectionInteractor interactor2 = new SelectionInteractor();
  ...
  private class LineAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      current_shape = new BasicFigure(new PaintedShape(new Line2D.Double(45.0, 10.0, 65.0, 30.0), 
						       outline_thickness, stroke_color));
  ...
  private class QuadraticAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      current_shape = new BasicFigure(new PaintedShape(new QuadCurve2D.Double(77.0, 10.0, 87.0, 20.0, 97.0, 30.0), 
						       outline_thickness, stroke_color));
  ...
  private class CubicAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      current_shape = new BasicFigure(new PaintedShape(new CubicCurve2D.Double(110.0, 10.0, 117.0, 17.0, 123.0, 23.0, 130.0, 30.0), 
						       outline_thickness, stroke_color));
