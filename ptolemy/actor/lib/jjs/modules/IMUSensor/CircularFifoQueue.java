/* CircularFifoQueue provides a Circular FIFO buffer queue and related functionaltiy

 * Modified for use with IMU sensor project code by Hunter Massey - only minor edits have been made
        ...
        return new Iterator<E>() {
            ...
            public void remove() {
                ...
                if (start < lastReturnedIndex && pos < end) {
                    // shift in one part
                    System.arraycopy(elements, pos, elements, lastReturnedIndex,
                            end - pos);
                } else {
