...
update
set savedir "[pwd]"
if {"CCodeGenerator.tcl CCodeGeneratorHelper.tcl CParseTreeCodeGenerator.tcl" != ""} {foreach i [list CCodeGenerator.tcl CCodeGeneratorHelper.tcl CParseTreeCodeGenerator.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] { if [ catch {source $i} msg] {puts "
