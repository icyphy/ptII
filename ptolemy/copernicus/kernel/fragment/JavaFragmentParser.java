...
public class JavaFragmentParser implements JavaFragmentParserConstants {
    ...
    public static void main(String args[]) {
        ...
        if (args.length == 0) {
            ...
            parser = new JavaFragmentParser(System.in);
        } else if (args.length == 1) {
            System.out.println("Java Parser Version 1.1:  Reading from file " + args[0] + " . . .");
            try {
                parser = new JavaFragmentParser(new java.io.FileInputStream(args[0]));
            ...
            System.out.println("         java JavaFragmentParser < inputfile");
            System.out.println("OR");
            System.out.println("         java JavaFragmentParser inputfile");
            return;
        }
        try {
            parser.ExpressionEntry();
    ...
    public static void add(
        JimpleBody body, String string) {
        Stmt insertPoint = Jimple.v().newNopStmt();
        body.getUnits().add(insertPoint);
        insertBefore(body, insertPoint, string);
    }
    public static void insertBefore(
        JimpleBody body, Stmt insertPoint, String string) {
        Reader reader = new StringReader(string);
        JavaFragmentParser parser = new JavaFragmentParser(reader);
        parser.statementEntry(body, insertPoint);
    }

    private void _bindNameToLocal(String name, Local local) {
        if(_nameToLocal.get(name) != null) {
            throw new RuntimeException("multiply bound name = " + name);
        } else {
            _nameToLocal.put(name, local);
        }
    }
    ...
    private RefType _findType(String name) {
    ...
    private Value _processInstanceField(Value baseValue, String name) {
        ...
        if(lastDotPosition == -1) {
            ...
            Value value = (Value) _nameToLocal.get(name);
            if(value != null) {
                return value;
            }
 ...
 */
  ...
  final public void statementEntry(JimpleBody body, Stmt insertPoint) throws ParseException {
    _body = body;
    _insertPoint = insertPoint;
    _nameToLocal = new HashMap();
 ...
 Value value;
  ...
  final public Value AllocationExpression() throws ParseException {
    ...
    case IDENTIFIER:
      ...
      case LPAREN:
        argList = Arguments();
                SootClass theClass = Scene.v().loadClassAndSupport(name);
