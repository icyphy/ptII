...
# ADD CPP /MD /W3 /GX /O2 /I "$(UDM_PATH)\include" /I "..\include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "UDM_DYNAMIC_LINKING" /YX /FD /c
# SUBTRACT CPP /nologo
...
# ADD CPP /MDd /W3 /Gm /GX /ZI /Od /I "$(UDM_PATH)\include" /I "..\include" /I "$(UDM_PATH)\3rdparty\stl" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "UDM_DYNAMIC_LINKING" /YX /FD /GZ /c
# SUBTRACT CPP /nologo
...
# ADD LINK32 xerces-c_2D.lib zlibD.lib udmDll_D.lib /nologo /subsystem:console /debug /machine:I386 /out:"..\bin\Xml2Ecsl_d.exe" /pdbtype:sept /libpath:"$(UDM_PATH)lib" /libpath:"$(UDM_PATH)3rdparty\zlib" /libpath:"$(UDM_PATH)3rdparty\xerces\xerces-c2_2_0-win32\lib"
