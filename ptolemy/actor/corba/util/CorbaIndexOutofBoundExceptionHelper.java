/*
 * File: ../../../ptolemy/actor/corba/util/CorbaIndexOutofBoundExceptionHelper.java
 * From: CorbaActor.idl
...
public class CorbaIndexOutofBoundExceptionHelper {
    ...
    public static void write(org.omg.CORBA.portable.OutputStream out, ptolemy.actor.corba.util.CorbaIndexOutofBoundException that) {
    out.write_string(id());

	out.write_short(that.index);
    }
    public static ptolemy.actor.corba.util.CorbaIndexOutofBoundException read(org.omg.CORBA.portable.InputStream in) {
        ptolemy.actor.corba.util.CorbaIndexOutofBoundException that = new ptolemy.actor.corba.util.CorbaIndexOutofBoundException();
