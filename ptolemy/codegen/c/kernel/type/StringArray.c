 ...
 * String: Int, Char, Array, etc.
 * %s: %d, %s, etc.
 * string: int, char, etc.
 * 100: 12(int), 22(long), 22(double), 6(boolean)
 */
...
Token StringArray_new(int size, int given, ...) { //Revised
    va_list argp;
    int i;
    Token result;
...
Token StringArray_delete(Token token, ...) { //Revised
    Token emptyToken;
    //Token element;
    //int i;
    //char elementType;
