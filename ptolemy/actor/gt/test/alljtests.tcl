...
update
set savedir "[pwd]"
if {"GeneratedModel1.tcl GeneratedModel2.tcl Match3Actors.tcl MatchHierarchy2Actors.tcl MatchHierarchy2Actors2Composites.tcl Match4Actors.tcl XMLTest5.tcl XMLTest6.tcl XMLTest7.tcl" != ""} {foreach i [list GeneratedModel1.tcl GeneratedModel2.tcl Match3Actors.tcl MatchHierarchy2Actors.tcl MatchHierarchy2Actors2Composites.tcl Match4Actors.tcl XMLTest5.tcl XMLTest6.tcl XMLTest7.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] { if [ catch {source $i} msg] {puts "
