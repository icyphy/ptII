...
{  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    InputStream fileStream = this.getClass().getClassLoader()
        .getResourceAsStream("ptolemy/plot/servlet/" + fName);
     ...
     */
    static public void writeAsJPEG(OutputStream out, Component cnt) throws IOException
    {  Dimension s = cnt.getSize();
    BufferedImage bufferedImage =
        new BufferedImage((int)s.getWidth(), (int)s.getHeight(),
     ...
     */
    private static void read(Plot plot, InputStream in) throws IOException
    {
        PlotMLParser parser;
