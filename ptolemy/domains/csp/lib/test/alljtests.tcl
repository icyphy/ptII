...
update
set savedir "[pwd]"
if {"Event.tcl ODActor.tcl ODDirector.tcl ODIOPort.tcl ODReceiver.tcl RcvrTimeTriple.tcl TimedQueueReceiver.tcl" != ""} {foreach i [list Event.tcl ODActor.tcl ODDirector.tcl ODIOPort.tcl ODReceiver.tcl RcvrTimeTriple.tcl TimedQueueReceiver.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] {source $i}}}
