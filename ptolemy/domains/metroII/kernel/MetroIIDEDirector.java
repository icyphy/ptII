...
import util.YieldAdapter.src.net.jimblackler.Utils.CollectionAbortedException;
import util.YieldAdapter.src.net.jimblackler.Utils.ResultHandler;
import util.metroII.metroIIcomm.Event;
import util.metroII.metroIIcomm.Event.Builder;

public class MetroIIDEDirector extends DEDirector implements M2EventHandler {

	public MetroIIDEDirector() {
	...
	@Override
	public Iterable<Iterable<Event.Builder> > adapter() {
