...
end pt_sfixed_compare;


ARCHITECTURE behave OF pt_sfixed_compare IS
--Constants
--Type Declarations
TYPE DELAYLINEA is ARRAY (1 to LATENCY) of sfixed (INPUTA_HIGH DOWNTO INPUTA_LOW);
TYPE DELAYLINEB is ARRAY (1 to LATENCY) of sfixed (INPUTB_HIGH DOWNTO INPUTB_LOW);
