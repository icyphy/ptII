...
First implementation.
        ...
        "Collection of models that illustrate model use and test models"
          ...
          model AirToOutlet1 "Model for testing state events"
            ...
            Modelica.Blocks.Sources.RealExpression m_flow(y=0.2*sin(time/2.5))
              "Sinewave mass flow rate"
          ...
          equation
           der( x) = 2;
            ...
            connect(m_flow.y, conAirNoC.m_flow)
              annotation (Line(points={{-75,68},{-40,68},{-2,68}}, color={0,0,127}));
          annotation (
              Documentation(info="<html>
<p>
This model is used to test state events. 
This model has 3 state events at t=0.0, 7.85, 
and 15.7 when simulated for 20 seconds.</p>
</html>
",                  revisions="<html>
<ul>
<li>
...
model Buildings_Fluid_FMI_Conversion_Validation_AirToOutlet1
 extends Buildings.Fluid.FMI.Conversion.Validation.AirToOutlet1;
  annotation(experiment(
    StopTime=1,
    __Dymola_NumberOfIntervals=500,
    Tolerance=0.0001,
    __Dymola_Algorithm="dassl"),uses(Buildings(version="4.0.0")));
end Buildings_Fluid_FMI_Conversion_Validation_AirToOutlet1;
