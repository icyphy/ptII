/*
 * File: motorController_private.h
 *
...
#ifndef _RTW_HEADER_motorController_private_h_
#define _RTW_HEADER_motorController_private_h_
...
#endif                                  /* _RTW_HEADER_motorController_private_h_ */
