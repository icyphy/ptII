J. Cardoso, July, 25, 2017.

These files are test models for revision 71943 HLA/Certi cosimulation framework.
It allows for static multi-instances discovering.

Static means that the user must put as many HlaSubscribers as HLA instances 
registered in the federation, see BillardTable.xml. 
