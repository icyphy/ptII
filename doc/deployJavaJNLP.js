...
return retval;},displayWebStartMessage:function(codebase){document.write('The Java Web Start version is preferred, though browsers with versions of Java earlier than Java 1.6.0_13 may only work with the applet version. See <a href="' + codebase +'/doc/webStartHelp.htm">Web Start Help</a> for details.');},createWebStartLaunchButton:function(jnlp,minimumVersion){if(deployJava.returnPage==null){deployJava.returnPage=jnlp;}
