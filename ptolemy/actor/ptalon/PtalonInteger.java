...
*/
public class PtalonInteger extends Parameter implements PtalonObject {
     ...
     */
    public PtalonInteger(NamedObj container, String name)
     ...
     */
    public PtalonInteger(NamedObj container, String name, Token token)
            throws IllegalActionException, NameDuplicationException {
