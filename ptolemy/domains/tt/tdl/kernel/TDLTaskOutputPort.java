 ...
 * - initialValue: a TDL output port has an initial value.
 * 
...
public class TDLTaskOutputPort extends TypedIOPort {
     ...
     */
    public TDLTaskOutputPort() throws IllegalActionException, NameDuplicationException {
        super();
        _init();
    }
     ...
     * @throws IllegalActionException 
     */
    public TDLTaskOutputPort(Workspace workspace) throws IllegalActionException, NameDuplicationException {
        super(workspace);
        _init();
    }
     ...
     *   a port already in the container.
     */
    public TDLTaskOutputPort(ComponentEntity container, String name, boolean isInput,
