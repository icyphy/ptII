...
public abstract class _CorbaActorImplBase extends org.omg.CORBA.DynamicImplementation implements ptolemy.actor.corba.util.CorbaActor {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           case 0: // ptolemy.actor.corba.util.CorbaActor.fire
              {
              ...
              break;
           case 1: // ptolemy.actor.corba.util.CorbaActor.getParameter
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              ...
              catch (ptolemy.actor.corba.util.CorbaUnknownParamException e1) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            ptolemy.actor.corba.util.CorbaUnknownParamExceptionHelper.insert(_except, e1);
                            r.except(_except);
                            return;
              }
              ...
              break;
           case 2: // ptolemy.actor.corba.util.CorbaActor.initialize
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              try {
              ...
              break;
           case 3: // ptolemy.actor.corba.util.CorbaActor.hasData
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
           ...
           case 6: // ptolemy.actor.corba.util.CorbaActor.setParameter
              ...
              catch (ptolemy.actor.corba.util.CorbaIllegalValueException e2) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            ptolemy.actor.corba.util.CorbaIllegalValueExceptionHelper.insert(_except, e2);
                            r.except(_except);
                            return;
              }
              org.omg.CORBA.Any __return = _orb().create_any();
           ...
           case 9: // ptolemy.actor.corba.util.CorbaActor.transferInput
              ...
              catch (ptolemy.actor.corba.util.CorbaIndexOutofBoundException e2) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            ptolemy.actor.corba.util.CorbaIndexOutofBoundExceptionHelper.insert(_except, e2);
                            r.except(_except);
                            return;
              }
              catch (ptolemy.actor.corba.util.CorbaIllegalValueException e3) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            ptolemy.actor.corba.util.CorbaIllegalValueExceptionHelper.insert(_except, e3);
                            r.except(_except);
                            return;
              }
              org.omg.CORBA.Any __return = _orb().create_any();
