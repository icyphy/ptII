...
update
set savedir "[pwd]"
if {"ConstVariableModelAnalysis.tcl Deep.tcl FreeVariableModelAnalysis.tcl" != ""} {foreach i [list ConstVariableModelAnalysis.tcl Deep.tcl FreeVariableModelAnalysis.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] { if [ catch {source $i} msg] {puts "Error: $msg"}}}}
