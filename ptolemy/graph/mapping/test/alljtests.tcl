...
update
set savedir "[pwd]"
if {"ToDoubleMapMapping.tcl ToIntMapMapping.tcl" != ""} {foreach i [list ToDoubleMapMapping.tcl ToIntMapMapping.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] { if [ catch {source $i} msg] {puts "Error: $msg"}}}}
