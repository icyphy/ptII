...
public class TestSaveModelsWithReferences {
    ...
    public void testSavingNewModel_WithReferences() throws Exception {
        ...
        dbModel.setModel("<?xml version=\"1.0\" standalone=\"no\"?>"
                        ...
                        + "<property name=\"_createdBy\" class=\"ptolemy.kernel.attributes.VersionAttribute\" value=\"8.1.devel\">"
                        + "</property>"
                        + "<property name=\"" + XMLDBModel.DB_REFERENCE_ATTR + "\" class=\"ptolemy.data.expr.StringParameter\" value=\"FALSE\">"
                        + "</property>"
                        ...
                        + "<entity name=\"modeltest\" class=\"ptolemy.actor.TypedCompositeActor\">"
                            + "<property name=\"" + XMLDBModel.DB_MODEL_ID_ATTR + "\" class=\"ptolemy.data.expr.StringParameter\" value=\"modeltest_1278356855859\">"
                            + "</property>"
                            + "<property name=\"_createdBy\" class=\"ptolemy.kernel.attributes.VersionAttribute\" value=\"8.1.devel\">"
                            + "</property>"
                            + "<property name=\"" + XMLDBModel.DB_REFERENCE_ATTR + "\" class=\"ptolemy.data.expr.StringParameter\" value=\"TRUE\">"
                            + "</property>"
