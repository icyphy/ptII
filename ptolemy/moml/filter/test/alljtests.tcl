...
update
set savedir "[pwd]"
if {"BackwardCompatibility.tcl RemoveGraphicalClasses.tcl" != ""} {foreach i [list BackwardCompatibility.tcl RemoveGraphicalClasses.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] { if [ catch {source $i} msg] {puts "Error: $msg"}}}}
