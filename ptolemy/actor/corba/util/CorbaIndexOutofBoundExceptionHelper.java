...
abstract public class CorbaIndexOutofBoundExceptionHelper {
    ...
    public static void insert(org.omg.CORBA.Any a,
            ptolemy.actor.corba.util.CorbaIndexOutofBoundException that) {
    ...
    public static ptolemy.actor.corba.util.CorbaIndexOutofBoundException extract(
            org.omg.CORBA.Any a) {
            ...
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.StructMember("index",
                            _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(ptolemy.actor.corba.util.CorbaIndexOutofBoundExceptionHelper
                            .id(), "CorbaIndexOutofBoundException", _members0);
                    __active = false;
                }
            }
        }
    ...
    public static ptolemy.actor.corba.util.CorbaIndexOutofBoundException read(
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            ptolemy.actor.corba.util.CorbaIndexOutofBoundException value) {
