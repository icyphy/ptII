...
abstract public class CorbaUnknownPortExceptionHelper {
    ...
    public static void insert(org.omg.CORBA.Any a,
            ptolemy.actor.corba.util.CorbaUnknownPortException that) {
    ...
    public static ptolemy.actor.corba.util.CorbaUnknownPortException extract(
            org.omg.CORBA.Any a) {
            ...
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[1] = new org.omg.CORBA.StructMember("message",
                            _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(ptolemy.actor.corba.util.CorbaUnknownPortExceptionHelper
    ...
    public static ptolemy.actor.corba.util.CorbaUnknownPortException read(
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            ptolemy.actor.corba.util.CorbaUnknownPortException value) {
