...
public class FMITypeMapper extends DefaultTypeMapper {
    ...
    protected FMITypeMapper() {
        ...
        // public Object toNative(Object value, ToNativeContext context) {
        // System.out.println("FMITypeMapper().toNative(): " + value + " " +
        // context);
        // return new Integer(Boolean.TRUE.equals(value) ? 1 : 0);
        // }
        // public Object fromNative(Object value, FromNativeContext context) {
        // System.out.println("FMITypeMapper().fromNative(): " + value + " " +
        // context);
        // return ((Integer)value).intValue() != 0 ? Boolean.TRUE :
        // Boolean.FALSE;
        // }
        // public Class nativeType() {
        // // BOOL is 32-bit int
        ...
        TypeConverter pointerConverter = new TypeConverter() {
            public Object toNative(Object value, ToNativeContext context) {
                System.out
                        .println("FMITypeMapper().pointerConverter.toNative(): "
                                + value + " " + context);
                if (value == null) {
                    return null;
                }
                ...
                return new Long(((Pointer) value).indexOf(0, (byte) 0));
            }
            ...
            public Object fromNative(Object value, FromNativeContext context) {
                ...
                System.out
                        .println("FMITypeMapper().pointerConverter.fromNative(): "
                                + value
                                + (value instanceof Pointer[] ? " Pointer []"
                ...
                new Exception("FMITypeMapper().pointerConverter.fromNative(): "
                        + value + " getLong").printStackTrace();
        ...
        new TypeConverter() {
            public Object toNative(Object value, ToNativeContext context) {
                System.out
                        .println("FMITypeMapper().objectConverter.toNative(): "
                                + value + " " + context);
                return value.toString();
            }
            ...
            public Object fromNative(Object value, FromNativeContext context) {
                System.out
                        .println("FMITypeMapper().objectConverter.fromNative(): "
                                + value + " " + context);
                return value.toString();
            }
