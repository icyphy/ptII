...
public class SaveModelManager {
     ...
     */
    public boolean save(XMLDBModel p_xmlDBModel) throws DBConnectionException, DBExecutionException, IllegalArgumentException
    {
	...
	try {
		...
		bIsSuccessful = true;
            ...
            throw new DBConnectionException("Failed to save the model - " +
        	    e.getMessage(), e);
