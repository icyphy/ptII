...
update
set savedir "[pwd]"
if {"BasePNDirector.tcl PNDirector.tcl PNQueueReceiver.tcl TimedPNDirector.tcl" != ""} {foreach i [list BasePNDirector.tcl PNDirector.tcl PNQueueReceiver.tcl TimedPNDirector.tcl] {puts $i; cd "$savedir"; if [ file exists $i ] {source $i}}}
