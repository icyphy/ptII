...
#define MODEL_IDENTIFIER Constant
#define MODEL_GUID "{a2a42484-2bd5-482b-84b6-08dfaf289353}"
...
void calculateValues(ModelInstance *comp) {
    // printf("Constant-calculateValues, time: %ld\n", comp->time);
...
void eventUpdate(ModelInstance* comp, fmi2EventInfo* eventInfo, int timeEvent) {
    // printf("Constant-eventUpdate, time: %ld\n", comp->time);
}
