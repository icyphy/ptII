...
#define MODEL_IDENTIFIER values20
#define MODEL_GUID "{8c4e810f-3df3-4a00-8276-176fa3c9f024}"
...
// Set values20 for all variables that define a start value
...
// if setStartValues or environment set new values20 through fmi2SetXXX.
// Lazy set values20 for all variable that are computed from other variables.
