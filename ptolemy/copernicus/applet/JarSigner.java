...
public class JarSigner {
    ...
    public static void sign(String jarFileName, String signedJarFileName, String keystoreFileName, String alias, char[] storePassword, char[] keyPassword) throws Exception {
        ...
        try {
            ...
            if (chain == null) {
                throw new Exception("Could not get certificate chain from alias \"" + alias
            ...
            JarSigner jarSigner = new JarSigner("ptolemy", privateKey, certChain);
    ...
    private /*static*/ SignatureFile _createSignatureFile(Manifest manifest, MessageDigest messageDigest)
        ...
        return new SignatureFile(new MessageDigest[]{messageDigest}, manifest, manifestDigester, this._alias, true);

    }


    private static Constructor _findConstructor(Class c, Class... argTypes) throws NoSuchMethodException {
    ...
    private static Method _findMethod(Class c, String methodName, Class... argTypes) throws NoSuchMethodException {
    ...
    public void _signJarFile(JarFile jarFile, OutputStream outputStream)
        ...
        SignatureFile signatureFile = _createSignatureFile(manifest, messageDigest);
        SignatureFile.Block block = signatureFile.generateBlock(_privateKey, _certChain, true, jarFile);
     ...
     */
    private static String _updateDigest(MessageDigest digest, InputStream inputStream)
            throws IOException {
        try {
     ...
     */
    private static Map _updateManifestDigest(Manifest manifest, JarFile jarFile, MessageDigest messageDigest, Map entries)
            throws IOException {
        ...
        while (jarElements.hasMoreElements()) {
            ...
            if (jarEntry.getName().startsWith("META-INF"))
                ...
                attributes.putValue("SHA1-Digest", _updateDigest(messageDigest, jarFile.getInputStream(jarEntry)));
    ...
    private class SignatureFile {
        ...
        public SignatureFile(MessageDigest digests[],
            ...
            writeMethod = _findMethod(JDKsfClass, WRITE_METHOD, OutputStream.class);
        }
