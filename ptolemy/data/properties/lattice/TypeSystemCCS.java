...
/*        
        PropertyTokenSolver portSolver = (PropertyTokenSolver) findSolver("firstValueToken");
        portSolver.resolveProperties(analyzer);
        
        portSolver = (PropertyTokenSolver) findSolver("extendedFirstValueToken");
        portSolver.resolveProperties(analyzer);
*/
