...
*/
     ...
     *  If non-zero, e.g. YES or true, then after a simulation has finished,
the star will report the number of overflow errors if any occurred
during the simulation. parameter with initial value "NO".
     */
    ...
    /**
     *  counter for overflow check operations parameter with initial value "0".
     */
...
if (((IntToken)((ReportOverflow).getToken())).intValue() == 1) // FIXME ReportOverflow should be a Boolean {
