...
/**
 * Abstract tests for {@link MatlabEngine} implementations (actual tests shall sub-class this class).
 * 
 * @author david
 *
 */
public abstract class AbstractMatlabEngineTests {
	...
	public void testGetAndPutMatlabObject_throwsExceptionForUnnamedObject() throws IllegalActionException {
		...
		} catch (@SuppressWarnings("unused") final IllegalActionException e) {
			// Then
	...
	@Test
	public void testClose_onInvalidInstanceThrowsException() {
		// With
		...
		try {
			...
			// Then...
			Assert.fail("exception expected, but missing");
		} catch (@SuppressWarnings("unused") IllegalActionException e) {
			// Then...
			Assert.assertTrue(true);
		}
	}
