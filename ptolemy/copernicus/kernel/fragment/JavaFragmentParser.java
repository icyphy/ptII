...
label_21: 
        while (true) {
            ...
            value1 = _createLocal("$booleanOr",
                    Jimple.v().newOrExpr(value1, value2));
        }
...
label_22: 
        while (true) {
            ...
            value1 = _createLocal("$booleanAnd",
                    Jimple.v().newAndExpr(value1, value2));
        }
...
label_26: 
        while (true) {
            ...
            case EQ:
                ...
                value1 = _createLocal("$eq",
                        Jimple.v().newEqExpr(value1, value2));
                break;

            case NE:
                jj_consume_token(NE);
                value2 = InstanceOfExpression();
                value1 = _createLocal("$ne",
                        Jimple.v().newNeExpr(value1, value2));
                break;
...
label_27: 
        while (true) {
            ...
            case LT:
                ...
                value1 = _createLocal("$lt",
                        Jimple.v().newLtExpr(value1, value2));
                break;

            case GT:
                jj_consume_token(GT);
                value2 = ShiftExpression();
                value1 = _createLocal("$gt",
                        Jimple.v().newGtExpr(value1, value2));
                break;

            case LE:
                jj_consume_token(LE);
                value2 = ShiftExpression();
                value1 = _createLocal("$lte",
                        Jimple.v().newLeExpr(value1, value2));
                break;

            case GE:
                jj_consume_token(GE);
                value2 = ShiftExpression();
                value1 = _createLocal("$gte",
                        Jimple.v().newGeExpr(value1, value2));
                break;
...
label_28: 
        while (true) {
            ...
            case LSHIFT:
                ...
                value1 = _createLocal("$shiftLeft",
                        Jimple.v().newShlExpr(value1, value2));
                break;

            case RSIGNEDSHIFT:
                jj_consume_token(RSIGNEDSHIFT);
                value2 = AdditiveExpression();
                value1 = _createLocal("$shiftRight",
                        Jimple.v().newShrExpr(value1, value2));
                break;

            case RUNSIGNEDSHIFT:
                jj_consume_token(RUNSIGNEDSHIFT);
                value2 = AdditiveExpression();
                value1 = _createLocal("$unsignedShiftRight",
...
label_29: 
        while (true) {
            ...
            case PLUS:
                ...
                value1 = _createLocal("$add",
                        Jimple.v().newAddExpr(value1, value2));
                break;

            case MINUS:
                jj_consume_token(MINUS);
                value2 = MultiplicativeExpression();
                value1 = _createLocal("$subtract",
                        Jimple.v().newSubExpr(value1, value2));
                break;
...
label_30: 
        while (true) {
            ...
            case STAR:
                ...
                value1 = _createLocal("$multiply",
                        Jimple.v().newMulExpr(value1, value2));
                break;

            case SLASH:
                jj_consume_token(SLASH);
                value2 = UnaryExpression();
                value1 = _createLocal("$divide",
                        Jimple.v().newDivExpr(value1, value2));
                break;
            ...
            case REM:
                ...
                value2 = UnaryExpression();
                value1 = _createLocal("$divide",
                        Jimple.v().newRemExpr(value1, value2));
                break;
    ...
    final public Value PreIncrementExpression() throws ParseException {
        ...
        Local local = _createLocal("$increment",
                Jimple.v().newAddExpr(value, IntConstant.v(1)));
    ...
    final public Value PreDecrementExpression() throws ParseException {
        ...
        Local local = _createLocal("$decrement",
                Jimple.v().newAddExpr(value, IntConstant.v(-1)));
    ...
    final public Value CastExpression() throws ParseException {
        ...
        if (true) {
            return _createLocal("$cast", Jimple.v().newCastExpr(value, type));
        }
...
label_44: 
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] {
                0x0, 0x0, 0x20102000, 0x0, 0x2000, 0x20002000, 0x20002000,
                0x8000000, 0x0, 0xa2196000, 0x20002000, 0x20002000, 0xa2094000,
                0x20002000, 0x20002000, 0x2000, 0x2000, 0x20002000, 0x20002000,
                0x8000000, 0xa2196000, 0xa2094000, 0x20000000, 0x20000000, 0x0,
                0x0, 0x0, 0x20002000, 0x20002000, 0x0, 0x0, 0x0, 0x0, 0xa2094000,
                0x20000000, 0x0, 0x0, 0x0, 0x0, 0xb359c000, 0x92094000, 0x0,
                0x82094000, 0x0, 0x82094000, 0x82094000, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x92094000, 0x0, 0x92094000, 0x10000000, 0x0, 0x0, 0x0, 0x0,
                0x10000000, 0x0, 0x0, 0x0, 0x10000000, 0x0, 0x92094000, 0x0, 0x0,
                0x0, 0x9349c000, 0xb359c000, 0xb359c000, 0x20000000, 0x0, 0x0,
                0x0, 0x92094000, 0x92094000, 0x0, 0x0, 0x0, 0x92094000, 0x820000,
    ...
    private static void jj_la1_1() {
        jj_la1_1 = new int[] {
                0x1000, 0x10, 0x8080, 0x0, 0x8080, 0x8000, 0x8000, 0x0, 0x8,
                0x3226e3c0, 0x4e000, 0x4e000, 0x2206e140, 0x24e200, 0x24e200,
                0x8000, 0x8000, 0x4e000, 0x4e000, 0x0, 0x3226e3c0, 0x2206e140,
                0x2204e000, 0x2204e000, 0x0, 0x0, 0x0, 0x24e200, 0x24e200,
                0x1000000, 0x0, 0x0, 0x0, 0x20140, 0x0, 0x0, 0xe000, 0xe000,
                0x1000000, 0xdcfb0dc5, 0x944a0d40, 0x40000, 0x20140, 0x0,
                0x20140, 0x10020140, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x944a0d40,
                0x0, 0x944a0d40, 0x84480c00, 0x0, 0x0, 0x0, 0x0, 0x84480c00, 0x0,
                0x0, 0x0, 0x84000800, 0x0, 0x944a0d40, 0x0, 0x0, 0x0, 0xdcfb0d45,
                0xdcfb0dc5, 0xdcfb0dc5, 0x0, 0x0, 0x0, 0x0, 0x944a0d40,
                0x944a0d40, 0x0, 0x0, 0x0, 0x944a0d40, 0x0, 0xdcfb0dc5,
                0xdcfb0dc5, 0x0, 0x0, 0x944a0d40, 0x944a0d40, 0x944a0d40,
                0x944a0d40, 0x0, 0x0, 0x0, 0x944a0d40, 0x0,
            };
    }

    private static void jj_la1_2() {
        jj_la1_2 = new int[] {
                0x0, 0x0, 0x10000, 0x40000, 0x10000, 0x0, 0x0, 0x0, 0x0, 0x1080,
                0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x80,
                0x0, 0x0, 0x20000, 0x80000, 0x4000, 0x0, 0x0, 0x0, 0x11000,
                0x4000, 0x20000, 0x80, 0x0, 0x4000, 0x0, 0x0, 0x0, 0x114e8,
                0x4e8, 0x0, 0x80, 0x4000, 0x0, 0x80, 0x20000, 0x80000, 0x1000000,
                0x40000000, 0x80000000, 0x0, 0x0, 0x0, 0x24000000, 0x24000000,
                0x0, 0x18300000, 0x18300000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0xc004e8, 0xc00000, 0x4e8, 0xc004e8, 0x400, 0x0, 0x0, 0x400,
                0x468, 0x80, 0x400, 0x44000, 0x68, 0x20000, 0xc004e8, 0x4400,
                0x4000, 0x4000, 0x14e8, 0x114e8, 0x114e8, 0x0, 0x20000, 0x4000,
                0x80000, 0xc014e8, 0xc014e8, 0x20000, 0x80000, 0x80000, 0x4e8,
                0x0, 0x114e8, 0x114e8, 0x0, 0x0, 0x4e8, 0xc004e8, 0x4e8, 0x4e8,
                0x20000, 0x80, 0x80, 0xc004e8, 0x0,
            };
    }
    ...
    private static void jj_la1_3() {
        jj_la1_3 = new int[] {
                ...
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffe000, 0x0, 0x0, 0x0,
                0x80, 0x100, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1c00, 0x1c00, 0xc,
                0xc, 0x230, 0x230, 0xf, 0x0, 0x0, 0x0, 0x0, 0x3, 0x3, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x0, 0x0, 0x0, 0x3, 0x3, 0x3, 0x0,
                0x0, 0x0, 0x0, 0xf, 0xf, 0x0, 0xffe003, 0xffe003, 0x3, 0x0, 0x3,
                0x3, 0x0, 0x0, 0x3, 0xf, 0x3, 0x3, 0x0, 0x0, 0x0, 0xf, 0x0,
            };
    }
