...
public class JarSigner {
    ...
    public static void main(String args[]) {
        if (args.length != 2) {
            System.err.println(
                    "Usage: java -classpath $PTII ptolemy.copernicus.applet.JarSigner JNLPApplication.jar JNLPSignedApplication.jar");
        }
        ...
        String keystorePropertiesFileName = StringUtilities.getProperty(
                "ptolemy.ptII.dir") + File.separator + "ptKeystore.properties";
        ...
        if (jarEntry != null) {
            ...
            while (entries.hasMoreElements()) {
                ...
                if ("META-INF/MANIFEST.MF"
                        .equalsIgnoreCase(jarEntry.getName())) {
                    break;
                } else {
                    jarEntry = null;
                }
            ...
            while (metaEntries.hasMoreElements()) {
                ...
                if (metaEntry.getName().startsWith("META-INF")
                        && !(manifestFileName
                                ...
                                || signatureFileName
                                        .equalsIgnoreCase(metaEntry.getName())
                                || signatureBlockName.equalsIgnoreCase(
                                        metaEntry.getName()))) {
     ...
     */
    private static Map _updateManifestDigest(Manifest manifest, JarFile jarFile,
    ...
    private static class SignatureFile {
        ...
        private static class Block {
            ...
            public Block(SignatureFile sfg, PrivateKey privateKey,
                ...
                try {
                    // Java 1.8.0_152
                    // javap -classpath /usr/lib/jvm/jdk1.8.0_152/jre/../lib/tools.jar 'sun.security.tools.jarsigner.SignatureFile$Block'
                    ...
                    constructor = _findConstructor(blockClass,
                            ...
                            String.class, X509Certificate[].class, Boolean.TYPE,
                            String.class, X509Certificate.class, String.class,
                            // Here is the diff between ~ 1.8.0_91 and 1.8.0_152
                            String.class, contentSignerClass, String[].class,
                            ZipFile.class);

                    block = constructor.newInstance(sfg
                            .getJDKSignatureFile(), /* explicit argument on the constructor */
                            privateKey, /*signatureAlgorithm*/null, certChain,
                            externalSF, null, null, null,
                            // Here is the diff between ~ 1.8.0_91 and 1.8.0_152
                            "SHA-1", null, null, zipFile);
                    ...
                    try {
                        ...
                        constructor = _findConstructor(blockClass,
                                ...
                                String.class, contentSignerClass,
                                String[].class, ZipFile.class);

                        block = constructor.newInstance(sfg
                                .getJDKSignatureFile(), /* explicit argument on the constructor */
                                privateKey, /*signatureAlgorithm*/null,
                                certChain, externalSF, null, null, null, null,
                                null, zipFile);
                        ...
                        try {
                            constructor = _findConstructor(blockClass,
                                    ...
                                    X509Certificate[].class, Boolean.TYPE,
                                    String.class, X509Certificate.class,
                                    contentSignerClass, String[].class,
                                    ZipFile.class);

                            block = constructor.newInstance(sfg
                                    .getJDKSignatureFile(), /* explicit argument on the constructor */
                                    privateKey, /*signatureAlgorithm*/null,
                                    certChain, externalSF, null, null, null,
                                    null, zipFile);
                            ...
                            try {
                                ...
                                block = constructor.newInstance(sfg
                                        .getJDKSignatureFile(), /* explicit argument on the constructor */
                                        privateKey, certChain, externalSF, null,
